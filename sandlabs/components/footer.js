      ...
      <footer className="sticky bottom-0 bg-gradient-to-r from-primary to-secondary w-full" style={{height: "5vh"}}>
        <Container>
          <div className="flex flex-row items-center justify-between" style={{height: "5vh"}}>
            ...
            <div className="flex flex-row justify-end items-center  w-full text-sm lg:text-base">
              <a target="_blank" rel="noopener noreferrer"
                href="mailto: admin@sandlabs.co"
                className="ml-4 duration-200 md:text-base lg:text-base text-xs bg-transparent hover:bg-accent hover:text-darker text-dark font-bold py-3 px-18 lg:px-8 transition-colors mb-0 lg:mb-0"
              >
                Contact
              </a>
              <a
                href="/"
                className="ml-4 bg-transparent hover:bg-accent hover:text-darker text-dark font-bold  md:text-base lg:text-base text-xs py-3 px-18 lg:px-8 duration-200 transition-colors mb-0 lg:mb-0"
              >
                © <span className="font-bold  md:text-base lg:text-base text-xs">SandLabs</span> 2021
              </a>
              {/* <a
